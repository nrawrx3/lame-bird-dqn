...
from rl_dqn import train_sb3_dqn
from rlbird import Command, CommandCommandType


def start_grpc_server(event_loop, rl_service):
    """
    ...
    event_loop.run_until_complete(grpc_server())


def start_env_loop__deprecated(loop, rl_service):
    """
...
def start_env_loop(event_loop, rl_service):
    train_sb3_dqn(rl_service)
